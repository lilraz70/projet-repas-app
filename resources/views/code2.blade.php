https://www.youtube.com/watch?v=v6kX9U5xxqQ&t=216s
            ...
            <div class="card-body">
                <div class="row g-3 mx-auto mt-3">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" wire:model="newData.libmetrepas" class="form-control" placeholder="Met repas"
                            required>
                    </div>


                    <div class="col-md-6 mb-4">
                        <div><label for="d2">Plante (Pour aucun enregistrement choisiez aucun dans la liste)</label>
                        </div>
                        
                        <select class="form-control js-example-basic-multiple" wire:model="newData1" multiple="multiple">
                            <option value="">-------</option>
                    ...
                    <div class="col-md-6 mb-4">
                        <div><label for="d2">Vivres (Pour aucun enregistrement choisiez aucun dans la liste)</label>
                        </div>
                        <select class="form-control js-example-basic-multiple" wire:model="newData2" multiple="multiple">
                            <option value="">-------</option>
                            <option value="">Aucun</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" wire:model="newData.quantite" class="form-control" placeholder="Quantite"
                            required>
                    </div>
