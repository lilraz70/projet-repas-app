<div class="col-12">
    ...
    <div class="card ">
            ...
            <table class="table table-head-fixed text-nowrap">
                <thead>
                    <tr>
                        ...
                        <th style="width:40%" class="text-center">Ceb</th>
                        <th style="width:25%" class="text-center">Commune</th>
                ...
                <tbody>
                    @foreach ($cebs as $ceb )
                    <tr>
                        <td class="text-center">{{$ceb->libceb}}</td>
                        <td class="text-center">{{$ceb->Commune->libcommune}}</td>
                        <td class="text-center">
                            <button class="btn btn-link" wire:click="gotoEdit({{$ceb->idceb}})"><i class="fa-solid fa-pen-to-square fa-1x "></i></button>
                            <button class="btn btn-link" wire:click="confirmDelete('{{$ceb->libceb}}', {{$ceb->idceb}})"><i class="fa-solid fa-trash fa-1x"></i></button>    
                            </td>
                    </tr>
                    @endforeach
        ...
        <div class="card-footer ">
            <div class="float-right "> {{ $cebs->links() }}</div>
        </div>
