    ...
    <div class="card ">
        ...
        <div class="card-body table-responsive p-0" style="height:350px;">
            <table class="table table-head-fixed text-nowrap">
                <thead>
                    <tr>
                        <th style="width:25%" class="text-center">Annescolaire</th>
                        <th style="width:25%" class="text-center">Ecole</th>
                        <th style="width:10%" class="text-center">Total Garcon</th>
                        <th style="width:25%" class="text-center">Total Fille</th>
                        <th style="width:25%" class="text-center">Total Coges Garcon</th>
                        <th style="width:25%" class="text-center">Total Coges Fille</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{$list->annescolaire}}</td>
                        <td class="text-center">{{$list->Ecole->libecole}}</td>
                        <td class="text-center">{{$list->nb_total_g}}</td>
                        <td class="text-center">{{$list->nb_total_f}}</td>
                        <td class="text-center">{{$list->nb_cges_g}}</td>
                        <td class="text-center">{{$list->nb_cges_f}}</td>
                        <td class="text-center">
                            <button class="btn btn-link" wire:click="gotoEdit({{$list->annescolaire}})"><i class="fa-solid fa-pen-to-square fa-1x "></i></button>
                            <button class="btn btn-link" wire:click="confirmDelete({{$list->annescolaire}})"><i class="fa-solid fa-trash fa-1x"></i></button>    
                            </td>
                    </tr>
                    @endforeach
