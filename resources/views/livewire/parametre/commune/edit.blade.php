    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            <div class="form-group">
                <div><label for="d2">Province</label></div>
                <select class="form-control " wire:model="editData.idprovince" required>
            ...
            <div class="form-group">
                <label for="d2">Commune</label>
                <input type="text" wire:model="editData.libcommune" class="form-control" placeholder="Commune" required>
            </div>
            <div class="form-group">
