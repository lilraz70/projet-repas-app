            ...
            <table class="table table-head-fixed text-nowrap">
                <thead>
                    <tr>
                        ...
                        <th style="width:30%" class="text-center">Province</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{$list->libcommune}}</td>
                        <td class="text-center">{{$list->superficie}}</td>
                        <td class="text-center">{{$list->Province->libprovince}}</td>
                        <td class="text-center">
                            <button class="btn btn-link" wire:click="gotoEdit({{$list->idcommune}})"><i class="fa-solid fa-pen-to-square fa-1x "></i></button>
                            <button class="btn btn-link" wire:click="confirmDelete('{{$list->libcommune}}', {{$list->idcommune}})"><i class="fa-solid fa-trash fa-1x"></i></button>    
                            </td>
                    </tr>
                    @endforeach
