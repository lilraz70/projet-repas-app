    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" wire:model="editData.libdispos" class="form-control" placeholder="Dispositif Hygiene" required>
            </div>
            <div class="form-group">
                <label for="d2">Quantite</label>
                <input type="text" wire:model="editData.quantite" class="form-control @error('editData.quantite')
                is-invalid
