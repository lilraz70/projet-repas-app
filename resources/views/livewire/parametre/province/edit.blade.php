    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            <div class="form-group">
                ...
                <select class="form-control " wire:model="editData.idregion" required>
            ...
            <div class="form-group">
                ...
                <input type="text" wire:model="editData.libprovince" class="form-control" placeholder="Province" required>
            </div>
            <div class="form-group">
                <label for="d2">Superficie</label>
                <input type="number" wire:model="editData.superficie" class="form-control
                @error('editData.superficie')
                    is-invalid
