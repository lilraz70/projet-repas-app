    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" wire:model="editData.libcsp" class="form-control" placeholder="Csp" required>
            </div>
            <div class="form-group">
                <label for="d2">Code Csp</label>
                <input type="text" wire:model="editData.codecsp" class="form-control" placeholder="Code Csp" required>
            </div>
