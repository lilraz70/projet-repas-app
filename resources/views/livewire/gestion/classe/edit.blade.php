<div class="card card-primary ">
    ...
    <div class="card-header bg-success text-white ">
        ...
        <h3 class="card-title "><i class="fa-solid fa-square-plus mr-1"></i>Formulaire</h3>
    </div>
    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" wire:model="editData.libclasse" class="form-control" placeholder="Classe" required>
            </div>
        </div>
