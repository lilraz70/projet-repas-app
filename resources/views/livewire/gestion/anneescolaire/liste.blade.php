    ...
    <div class="card ">
        ...
        <div class="card-body table-responsive p-0" style="height:350px;">
            <table class="table table-head-fixed text-nowrap">
                <thead>
                    <tr>
                        <th style="width:10%" class="text-center">Anne</th>
                        <th style="width:25%" class="text-center">Date debut</th>
                        <th style="width:25%" class="text-center">Date fin</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$list->datedebut}}</td>
                        <td class="text-center">{{$list->datefin}}</td>
                        <td class="text-center">
                            <button class="btn btn-link" wire:click="gotoEdit({{$list->anne}})"><i class="fa-solid fa-pen-to-square fa-1x "></i></button>
                            <button class="btn btn-link" wire:click="confirmDelete({{$list->anne}}, {{$list->anne}})"><i class="fa-solid fa-trash fa-1x"></i></button>    
                            </td>
                    </tr>
                    @endforeach
