    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            ...
            <div class="form-group">
                <div><label for="d2">Utilisateur</label></div>
                <select class="form-control " wire:model="editData.iduser" required>
                    <option value="">-------</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control " wire:model="editData.idrole" required>
                    <option value="">---------</option>
