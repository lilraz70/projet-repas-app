    ...
    <div class="card ">
        <div class="card-header bg-success text-white  d-flex align-items-center">
            <h3 class="card-title flex-grow-1"><i class="fa-sharp fa-solid fa-clipboard-list fa-2x mr-1"></i>Liste
                des Dispositif Hygienes et des ecoles</h3>
        ...
        <div class="card-body table-responsive p-0" style="height:350px;">
            <table class="table table-head-fixed text-nowrap">
                <thead>
                    <tr>
                        <th style="width:30%" class="text-center">Dispositif Hygiene</th>
                        <th style="width:15%" class="text-center">Ecole</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{$list->Dispositifhyg->libdispos}}</td>
                        <td class="text-center">{{$list->Ecole->libecole}}</td>
                        
                        <td class="text-center">
                            <button class="btn btn-link" wire:click="gotoEdit({{$list->iddisposecole}})"><i class="fa-solid fa-pen-to-square fa-1x "></i></button>
                            <button class="btn btn-link" wire:click="confirmDelete('{{$list->iddisposecole}}')"><i class="fa-solid fa-trash fa-1x"></i></button>    
                            </td>
                    </tr>
                    @endforeach
