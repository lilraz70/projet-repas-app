    ...
    <form role="form" wire:submit.prevent="editInBd()">
        <div class="card-body">
            ...
            <div class="col-md-6 mb-4">
                ...
                <input type="text" wire:model="editData.libmetrepas" class="form-control" placeholder="Met repas" required>
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" wire:model="editData.quantite" class="form-control" placeholder="Quantite"
                    required>
            </div>
